...
function tabBtn(a){
    document
    .querySelctorAll('.tab-button')
    [a].addEventListener("click",function(){
        for(
            let i=0;
            i<document.querySelctorAll(".tab-button").length;
            i++
            ){
...
// document
// .querySelctorAll('.tab-button')[0]
// .addEventListener("click",function(){
//     for(let i=0; i<document.querySelctorAll(".tab-button").length; i++){
//         document.querySelectorAll(.tab-button)[i].classList.remove("here");
//         document.querySelectorAll(.tab-button)[i].classList.remove("show");
//     }
...
//     document.querySelctorAll(".tab-content")[0].classList.add("show");
// });
